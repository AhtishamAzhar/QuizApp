...
class _ScoreState extends State<Score> {
              ...
              children: [
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text("Correct Answers: ${widget.correct}",
                              ...
                              Row(
                                children: [
                                  Text("Wrong Answers: ${widget.wrong} ",
                                      style: TextStyle(color: Colors.white)),
                                  Icon(
                ...
                Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Center(
                          child: int.parse(widget.score) < 10
                              ? Text(
                                  'Try Next Time',
                                  style: TextStyle(
  ...
  void sharee() {
    Share.share('com.example.quiz');
  }

  Widget buildIconButton(Function() onPressed, IconData iconData,
      String discription, BuildContext context) {
    return Column(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
        Container(
